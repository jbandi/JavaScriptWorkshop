 ...
 *
 * $Date: 2008-08-14 10:03:05 -0400 (Thu, 14 Aug 2008) $
 * $Rev: 5829 $
 */
...
jQuery.extend({
	...
	filter: function(t,r,not) {
		...
		while ( t && t != last ) {
			...
			// nth-last-child. just for fun :)
			}  else if ( m[1] == ":" && m[2] == "nth-last-child" ) {
				var merge = {}, tmp = [],
					// parse equations like 'even', 'odd', '5', '2n', '3n+2', '4n-1', '-n+6'
					test = /(-?)(\d*)n((?:\+|-)?\d*)/.exec(
						m[3] == "even" && "2n" || m[3] == "odd" && "2n+1" ||
				...
				for ( var i = 0, rl = r.length; i < rl; i++ ) {
					...
					if ( !merge[id] ) {
						...
						for ( var n = parentNode.lastChild; n; n = n.previousSibling )
							if ( n.nodeType == 1 )
								n.nodeIndex = c--;
